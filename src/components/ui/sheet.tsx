  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "glass-strong fixed top-0 z-50 h-full w-80 max-w-[calc(100%-2rem)] p-5 text-foreground outline-none duration-200 data-open:animate-in data-closed:animate-out",
